...
$updateStmt = $database->exe("UPDATE `records` SET `status` = 2 WHERE id = ?", [$id]);

// Send the email
$mail = new Mail;
$mail->sendMail($recordUser['email'], 'Request Paid', file_get_contents(dirname(__FILE__)."/../../../../../email-htmls/formPaid.html"));
